...
* Plan to restart this PC after an upgrade 2023-11-22
...
* Plan to add defalias of most common emacs commands https://www.youtube.com/watch?v=ufVldIrUOBg
* Plan to learn ubuntu ufw setup
* Plan to reset pagedown key in KA2 since no need for extensive use of Alt-key in xah-fly-keys.
